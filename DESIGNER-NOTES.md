...
## Copy placeholders
`[INSERT RAZORPAY PAYMENT LINK]`, `[INSERT DOWNLOAD LINK]`, `[INSERT SUPPORT EMAIL]`. Price (₹399) and author (GrubBite) are set. Payment runs through a Razorpay Payment Button — see RAZORPAY-SETUP.md.
